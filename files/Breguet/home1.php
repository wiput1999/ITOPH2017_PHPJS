...
if (isset($_POST['user'])) {
  ...
  $MM_redirectLoginSuccess = "home1-d.php";
  $MM_redirectLoginFailed = "home1.php";
      ...
      <table width="300" height="100" bgcolor="#00CCFF" border="0" cellspacing="1" cellpadding="1">
        <tr>
          <td><table width="276" border="0"  cellspacing="1" cellpadding="1">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input type="submit" name="d" id="d" value="ล็อกอิน" /></td>
            </tr>
          </table></td>
        </tr>
    </table>
      ...
      <table width="756" border="0" cellpadding="1" cellspacing="1">
        ...
        <?php do { ?>
          <tr>
            ...
            <td align="center"><a href="post-view.php?post_id=<?php echo $row_Recordset1['post_id']; ?>"><?php echo $row_Recordset1['post_t']; ?></a></td>
