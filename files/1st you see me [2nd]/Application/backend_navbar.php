<nav class="navbar navbar-default navbar-fixed-top" style="font-size: 20px;">
	...
	<a class="navbar-brand" href="#" style="font-size: 20px;">จัดการระบบ</a>
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			...
			?>
			<?php 
			if($_GET['manage_type'] == 'true'){
				?>
				<li class="active"><a href="admin.php?manage_type=true" class="hover">แก้ไขหมวดหมู่</a></li>
				<?php
			}else{
				?>
				<li><a href="admin.php?manage_type=true" class="hover">แก้ไขหมวดหมู่</a></li>
				<?php
			}				
			?>
			<?php 
